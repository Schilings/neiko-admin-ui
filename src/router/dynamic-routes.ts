...
//暂时写死
export const authViewRoutes:RouteRecordRaw =  {
    path: "/authorization",
    redirect: "/authorization/client",
    name: "Auth",
    meta: {
      name: "授权管理",
      icon: "setting",
    ...
    children: [
      {
        path: "/authorization/client",
        name: "AuthClient",
        meta: {
          name: '授权客户端',
          targetType: 1
        },
        component: () => import('@/views/authorization/client/RegisteredClientPage.vue')
      },
      {
        ...
        component: () => import('@/views/authorization/authorization/AuthorizationPage.vue')
      },
      {
        path: "/authorization/authorizationConsent",
        name: "AuthAuthorizationConsent",
        meta: {
          name: '授权同意记录',
          targetType: 1
        },
        component: () => import('@/views/authorization/consent/AuthorizationConsentPage.vue')
      },
    ],
  }
