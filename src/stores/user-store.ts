...
const refreshTokenKey = getStorageKey('refresh-token')
const idTokenKey = getStorageKey('id-token')
...
export const useUserStore = defineStore('userStore', {
  ...
  state: () => ({
    ...
    refreshToken: useLocalStorage<string | undefined>(refreshTokenKey, undefined, {
      writeDefaults: false
    }),
    idToken: useLocalStorage<string | undefined>(idTokenKey, undefined, {
      writeDefaults: false
    }),
