        ...
        <template v-if="!searchCollapsed">
          <a-col :xl="8" :md="12" :sm="24">
            <a-form-item label="认证方式">
              <a-input v-model:value="formModel.clientAuthenticationMethod" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :xl="8" :md="12" :sm="24">
          ...
          <a-col :xl="8" :md="12" :sm="24">
            <a-form-item label="作用域">
              <a-input v-model:value="formModel.scope" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :xl="8" :md="12" :sm="24">
...
<script lang='ts'>
export default {
  name: 'RegisteredClientPageSearch'
}
</script>
<style scoped>
